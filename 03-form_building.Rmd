...
To see how this list is filtered by stream click on the *Condition Value* button in the upper-left hand corner of the option list window. 


```{r echo = FALSE, out.width = "50%"}
knitr::include_graphics("screenshots/option_condition.png")
```
